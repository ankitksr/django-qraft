...
print("   Command: uv run python manage.py qraftcluster")
...
print("   Command: Q_CLUSTER_NAME=qraft uv run python manage.py qraftcluster")
...
print("  Terminal 1: uv run python manage.py qraftcluster")
print("  Terminal 2: Q_CLUSTER_NAME=qraft uv run python manage.py qraftcluster")
print("  Terminal 3: uv run python manage.py demo perf -n 20 --duration 1.0")
print()
